...
insert into users(firstName, lastName, school, username, password)
  values ('dhruv','gupta','DPS','dgupta','php123');

insert into tbl_student_info (student_id,father, mother, f_phone, m_phone, DOB)
  values (1,'Shishir','Archana','(404)717-5785','(404)717-5785','2008-7-04');
